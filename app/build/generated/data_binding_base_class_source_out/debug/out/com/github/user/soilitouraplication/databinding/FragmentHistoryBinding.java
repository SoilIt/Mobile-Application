...
public final class FragmentHistoryBinding implements ViewBinding {
  ...
  private FragmentHistoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextInputEditText editText, @NonNull FrameLayout frameLayout,
      @NonNull RecyclerView history, @NonNull SwipeRefreshLayout swipeRefreshLayout) {
  ...
  public static FragmentHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.history;
      RecyclerView history = ViewBindings.findChildViewById(rootView, id);
      if (history == null) {
        break missingId;
      }
      ...
      return new FragmentHistoryBinding((ConstraintLayout) rootView, editText, frameLayout, history,
          swipeRefreshLayout);
    }
